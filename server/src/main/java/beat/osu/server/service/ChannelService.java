...
public class ChannelService {
    ...
    private static final int LOBBY_CHANNEL_ID = 3;
    ...
    public ChannelService(SessionService sessionService, UserService userService) {
        ...
        channels.put(3, new Channel(3, "#lobby", "Advertise your Multiplayer game."));
        channels.put(4, new Channel(4, "#arabic", "Arabic community channel."));
        channels.put(5, new Channel(5, "#bulgarian", "Bulgarian community channel."));
        channels.put(6, new Channel(6, "#cantonese", "Cantonese community channel."));
        channels.put(7, new Channel(7, "#chinese", "Chinese community channel."));
        channels.put(8, new Channel(8, "#ctb", "Discuss osu!catch (previously Catch The Beat)."));
        channels.put(9, new Channel(9, "#czechlovak", "Czechlovak community channel."));
        channels.put(10, new Channel(10, "#dutch", "Dutch community channel."));
        channels.put(11, new Channel(11, "#english", "English community channel."));
        channels.put(12, new Channel(12, "#french", "French community channel."));
        channels.put(13, new Channel(13, "#german", "German community channel."));
        channels.put(14, new Channel(14, "#japanese", "Japanese community channel."));
        channels.put(15, new Channel(15, "#korean", "Korean community channel."));
        channels.put(16, new Channel(16, "#portuguese", "Portuguese community channel."));
        channels.put(17, new Channel(17, "#russian", "Russian community channel."));
        channels.put(18, new Channel(18, "#spanish", "Spanish community channel."));
        channels.put(19, new Channel(19, "#thai", "Thai community channel."));
        channels.put(20, new Channel(20, "#turkish", "Turkish community channel."));
        channels.put(21, new Channel(21, "#vietnamese", "Vietnamese community channel."));
        channels.put(22, new Channel(22, "#mania", "Discuss osu!mania, the 4-key and more beatmap mode."));
        channels.put(23, new Channel(23, "#taiko", "Discuss osu!taiko, the drumming beatmap mode."));
        channels.put(24, new Channel(24, "#modding", "For mappers and modders to discuss beatmap creation and feedback."));
        channels.put(25, new Channel(25, "#tournaments", "Announcements and discussion about official and community tournaments."));
        channels.put(26, new Channel(26, "#help", "Ask for help with the game client, website, or common issues."));
        channels.put(27, new Channel(27, "#art", "Share and discuss osu! related fan art and creative works."));
        channels.put(28, new Channel(28, "#skins", "Discuss and share custom osu! skins."));
        channels.put(29, new Channel(29, "#development", "Discussions about the ongoing development of osu! and its features."));
    ...
    public Result<JoinChannelResponse> joinChannel(JoinChannelRequest request, String clientId) {
        ...
        Result<JoinChannelResponse> response = Result.success(new JoinChannelResponse(channelDto));
